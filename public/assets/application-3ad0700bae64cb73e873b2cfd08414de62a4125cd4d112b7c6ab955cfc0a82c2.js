...
(function() { this.JST || (this.JST = {}); this.JST["truck_list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="https://www.google.com/?gws_rd=ssl#q=',  truck.escape("applicant") ,'">\n  <h4>',  truck.escape("applicant") ,'</h4>\n  <p>',  truck.escape("fooditems") ,'</p>\n</a>\n');}return __p.join('');};
}).call(this);
